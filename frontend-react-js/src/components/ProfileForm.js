...
export default function ProfileForm(props) {
  ...
  const s3uploadkey = async (extension) => {
    ...
    try {
      const gateway_url = "https://bwyhdudx65.execute-api.us-east-1.amazonaws.com/avatars/key_upload"
      ...
      const res = await fetch(gateway_url, {
        ...
        headers: {
          ...
          'Origin': "https://3000-mangofunky-awsbootcampc-0xhej685uw4.ws-eu96.gitpod.io",
